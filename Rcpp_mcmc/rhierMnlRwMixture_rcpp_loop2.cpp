...
//                           int count_out,int initial_price_id,vec const& initial_price_state_dropped,
...
Rcpp::Function llmnl_initial_mcprice = global["llmnl_initial_mcprice"];
...
<<<<<<< HEAD
  NumericVector clltmp = llmnl_initial_mcprice(betac,y,X,count_out,initial_price_id,initial_price_state_dropped,
...
<<<<<<< HEAD
      for(int lgt = 0; lgt<nlgt; lgt++){
        ...
        NumericVector tmpll = llmnl_initial_mcprice(vectorise(oldbetas(lgt,span::all)),lgtdata_vector[lgt].y,lgtdata_vector[lgt].X,
                                                    count_out,initial_price_id,initial_price_state_dropped,
                                                    s1,transition_matrix_median_steps,price_transition_states,
                                                    vec_price_states_probs,draws_length,number_price_simulations,
                                                    flag_markovian,flag_know_state);
        
        if (rep == 0) oldll[lgt] = tmpll[0];
